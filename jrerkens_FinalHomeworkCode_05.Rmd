...
library(tidyverse)
library(curl)
kandc <- read_csv(curl("https://raw.githubusercontent.com/fuzzyatelin/fuzzyatelin.github.io/master/AN588_Fall21/KamilarAndCooperData.csv")) %>% filter(is.na(HomeRange_km2) == F & is.na(Body_mass_female_mean) == F) # per Nicole
head(kandc)
```
