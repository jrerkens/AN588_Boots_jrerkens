---
title: "Homework 5! - Peer Commentary"
...
# Peer Commentary
*1. What you learned from running their Original Homework Code that helped improve your own code.* I liked seeing the for loop version of doing the boot strapping since I used a different method using the mosaic package functions do() and resample(). <br>
*2. What you did in your own code that might help to improve theirs.* I removed the NAs from the two variables before doing the first linear regression. This got me slightly different B1 and B0 values <br>
*3. What challenges, if any, you both faced in your code that could not be helped by comparison.* I don't think we had any of the same challenges exactly. I might try looking at my confidence intervals again since you used the quantiles() function but I think I got pretty similar intervals to you in the end so maybe the slightly different approaches made it unnecessary for me. <br>
*4. Whether the annotation/commenting on your peer’s Original Homework Code is readable and interpretable to you, and if not then how it could be improved.* Really great and clear use of headers and naming of chunks. Lots of breaks to easily see what is what. Notes so I can always follow along with what your doing. <br>
